...
List<Region> regions = [
  Region(
    adjacentRegions: [1],
    countries: [
      Country(name: "United States", abbreviation: "us", maximumEnergy: 10000),
      Country(name: "Canada", abbreviation: "ca", maximumEnergy: 7500),
    ],
    name: "North America",
    verticalOffset: 15,
    horizontalOffset: 20,
  ...
  Region(
      ...
      countries: [
        ...
        Country(name: "Mexico", abbreviation: "mx", maximumEnergy: 7500),
  ...
  Region(
      ...
      countries: [
        ...
        Country(name: "Brazil", abbreviation: "br", maximumEnergy: 10000),
  ...
  Region(
      ...
      countries: [
        ...
        Country(name: "Germany", abbreviation: "de", maximumEnergy: 7500),
        ...
        Country(name: "Spain", abbreviation: "es", maximumEnergy: 7500),
        ...
        Country(
            name: "United Kingdom", abbreviation: "gb", maximumEnergy: 7500),
  ...
  Region(
      ...
      countries: [
        ...
        Country(name: "Russia", abbreviation: "ru", maximumEnergy: 10000),
  ...
  Region(
      ...
      countries: [
        Country(name: "China", abbreviation: "cn", maximumEnergy: 10000),
        Country(name: "Japan", abbreviation: "jp", maximumEnergy: 7500),
  ...
  Region(
      ...
      countries: [
        ...
        Country(name: "India", abbreviation: "in", maximumEnergy: 10000),
  ...
  Region(
      ...
      adjacentRegions: [],
      countries: [
        Country(name: "Australia", abbreviation: "au", maximumEnergy: 10000),
